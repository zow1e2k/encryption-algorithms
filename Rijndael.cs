...
namespace SymmetricAlgths {
    public class Rijndael : Algorithm, ISymmetricAlgorithm {
        ...
        public Rijndael(CipherMode cipherMode, PaddingMode paddingMode) {
            ...
            //Console.WriteLine(" Symmetric algorithm Rijndael has been created");
        ...
        public int runSymmAlg(String str) {
            ...
            try {
                fs = new FileStream("out/encryptedText_Rijndael.txt", FileMode.OpenOrCreate);
            ...
            try {
                fs = new FileStream("out/decryptedText_Rijndael.txt", FileMode.OpenOrCreate);
